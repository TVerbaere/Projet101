...
/**
 * used to handle elements on a communication diagram.
 * 
 * @author Thibaud VERBAERE
 *
 */
public class CommunicationDiagramHandler extends AbstractDiagramHandler {
	
	
	private UMLDiagramEditor diagramEditor;
	

	public CommunicationDiagramHandler(EObject model,
